 ...
 */
final class Version20231017095042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, nom_entreprise VARCHAR(255) NOT NULL, description_entreprise LONGTEXT NOT NULL, adresse_entreprise VARCHAR(255) DEFAULT NULL, telephone_entreprise VARCHAR(255) DEFAULT NULL, etat_entreprise VARCHAR(255) DEFAULT NULL, secteur_entreprise VARCHAR(255) NOT NULL, date_creation VARCHAR(255) NOT NULL, date_validation VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, nombre_place INT DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, rccm VARCHAR(255) NOT NULL, idnat VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_D19FA60E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, nom VARCHAR(255) NOT NULL, postnom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone_etudiant VARCHAR(255) NOT NULL, etat_etudiant VARCHAR(255) DEFAULT NULL, promotion VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_717E22E3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
